...
namespace BulkyWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult ShipOrder()
        {
            ...
            {
                orderHeader.PaymentDueDate = orderHeader.PaymentDueDate;
            }
        ...
        public IActionResult CancelOrder()
        {
            ...
            if(orderHeader.PaymentStatus == SD.PymentStatusApproved)
            {
        ...
        public IActionResult PaymentConfirmation(int orderHeaderId)
        {
            ...
            if (orderHeader.PaymentStatus == SD.PymentStatusDelayedPayment)
            {
                ...
                if (session.PaymentStatus.ToLower() == "paid")
                {
                    ...
                    _unitOfWork.OrderHeader.UpdateStatus(orderHeaderId, orderHeader.OrderStatus, SD.PymentStatusApproved);
                    _unitOfWork.Save();
                }
            }
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                case "pending":
                    obj = obj.Where(u => u.PaymentStatus == SD.PymentStatusDelayedPayment);
                    break;
                case "inprocess":
